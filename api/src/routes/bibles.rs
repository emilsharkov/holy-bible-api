...
pub fn get_bible_routes() -> Router<AppState> {
    Router::<AppState>::new()
        ...
        .route("/bibles/:bibleId/search", get(bibles::get_verse_by_search))
        .route("/bibles/:bibleId/books", get(books::get_books))
        .route("/bibles/:bibleId/books/:bookNum/chapters", get(chapters::get_chapters))
        .route(
