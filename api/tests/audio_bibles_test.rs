...
mod validation_tests {
    ...
    async fn test_get_audio_bibles_invalid_language_too_long() {
        ...
        let response = client
            .get(&format!("{}/audio_bibles?language={}", server.base_url, long_language))
            .send()
            .await
            .expect("Failed to send request");
    ...
    async fn test_get_audio_bibles_invalid_version_too_long() {
        ...
        let response = client
            .get(&format!("{}/audio_bibles?version={}", server.base_url, long_version))
            .send()
            .await
            .expect("Failed to send request");
    ...
    async fn test_get_audio_bible_chapters_invalid_book_num_zero() {
        ...
        if let Some(audio_bible) = audio_bibles.first() {
            ...
            let response = client
                .get(&format!("{}/audio_bibles/{}/books/0/chapters", server.base_url, audio_bible_id))
                .send()
                .await
                .expect("Failed to send request");
    ...
    async fn test_get_audio_bible_chapters_invalid_audio_bible_id_zero() {
        ...
        let response = client
            .get(&format!("{}/audio_bibles/0/books/1/chapters", server.base_url))
            .send()
            .await
            .expect("Failed to send request");
    ...
    async fn test_get_audio_chapter_invalid_chapter_num_zero() {
        ...
        if let Some(audio_bible) = audio_bibles.first() {
            ...
            let response = client
                .get(&format!("{}/audio_bibles/{}/books/1/chapters/0", server.base_url, audio_bible_id))
                .send()
                .await
                .expect("Failed to send request");
    ...
    async fn test_get_audio_chapter_invalid_audio_bible_id_zero() {
        ...
        let response = client
            .get(&format!("{}/audio_bibles/0/books/1/chapters/1", server.base_url))
            .send()
            .await
            .expect("Failed to send request");
    ...
    async fn test_get_audio_chapter_invalid_book_num_zero() {
        ...
        if let Some(audio_bible) = audio_bibles.first() {
            ...
            let response = client
                .get(&format!("{}/audio_bibles/{}/books/0/chapters/1", server.base_url, audio_bible_id))
                .send()
                .await
                .expect("Failed to send request");
