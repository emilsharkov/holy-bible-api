...
async fn test_get_bibles() {
    ...
    if let Some(bible) = bibles.first() {
        assert!(
            bible.get("bible_id").is_some(),
            "Bible should have bible_id"
        );
        assert!(
            bible.get("language").is_some(),
            "Bible should have language"
        );
...
async fn test_get_bibles_with_query_params() {
    ...
    assert_eq!(
        response.status(),
        200,
        "GET /bibles?language=en should return 200"
    );
...
async fn test_get_bible_books() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        assert_eq!(
            response.status(),
            200,
            "GET /bibles/{{bible_id}}/books should return 200"
        );
...
async fn test_get_bible_chapters() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        if num_books > 0 {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters",
                    server.base_url, bible_id
                ))
                .send()
                .await
                .expect("Failed to send request");
            ...
            assert_eq!(
                response.status(),
                200,
                "GET /bibles/{{id}}/books/{{num}}/chapters endpoint should return 200"
            );
...
async fn test_get_bible_verses() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        let response = client
            .get(&format!(
                "{}/bibles/{}/books/1/chapters/1/verses",
                server.base_url, bible_id
            ))
            .send()
            .await
        ...
        assert_eq!(
            response.status(),
            200,
            "GET /bibles/{{id}}/books/{{num}}/chapters/{{num}}/verses endpoint should return 200"
        );
...
async fn test_get_bible_verse_by_number() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        let response = client
            .get(&format!(
                "{}/bibles/{}/books/1/chapters/1/verses/1",
                server.base_url, bible_id
            ))
            .send()
            .await
...
async fn test_get_random_bible_verse() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        assert_eq!(
            response.status(),
            200,
            "GET /bibles/{{id}}/random endpoint should return 200"
        );
...
async fn test_get_verse_of_the_day() {
    ...
    if let Some(bible) = bibles.first() {
        ...
        assert_eq!(
            response.status(),
            200,
            "GET /bibles/{{id}}/verse-of-the-day endpoint should return 200"
        );
...
mod validation_tests {
    ...
    async fn test_get_bible_verses_invalid_start_zero() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/1/verses?start=0",
                    server.base_url, bible_id
                ))
                .send()
                .await
    ...
    async fn test_get_bible_verses_invalid_start_negative() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/1/verses?start=-1",
                    server.base_url, bible_id
                ))
                .send()
                .await
    ...
    async fn test_get_bible_verses_invalid_end_zero() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/1/verses?end=0",
                    server.base_url, bible_id
                ))
                .send()
                .await
    ...
    async fn test_get_bible_verses_invalid_chapter_num_zero() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/0/verses",
                    server.base_url, bible_id
                ))
                .send()
                .await
    ...
    async fn test_get_bible_verse_by_number_invalid_verse_num_zero() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/1/verses/0",
                    server.base_url, bible_id
                ))
                .send()
                .await
    ...
    async fn test_get_bible_verses_invalid_range_start_greater_than_end() {
        ...
        if let Some(bible) = bibles.first() {
            ...
            let response = client
                .get(&format!(
                    "{}/bibles/{}/books/1/chapters/1/verses?start=10&end=5",
                    server.base_url, bible_id
                ))
                .send()
                .await
